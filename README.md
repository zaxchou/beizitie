...
**背字帖**把历代碑帖拆成单字高清卡，用 SM-2 间隔重复算法帮你高效背记字形。收录欧颜柳赵、二王、智永、宋徽宗等 **368 位书家、2707 部碑帖字库、172 万余张单字**，覆盖楷行草隶篆（行 1409 / 楷 576 / 草 488 / 隶 141 / 篆 92）。其中 **1476 部已通过字图一致性核验**（41.7 万单字），是集字功能的取字范围。
...
**当前能力**：市场浏览（2705 帖，离线目录）→ 订阅 → SM-2 学习 → 集字（1476 部已核验帖）→ 深色模式 → 字图离线缓存（断网可复习）→ 导出/导入 JSON 备份（与在线版互通）。
